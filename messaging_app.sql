...
ALTER TABLE `group_message`
ADD CONSTRAINT `group_message_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `group_member` (`group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `group_message_ibfk_2` FOREIGN KEY (`sent_by`) REFERENCES `group_member` (`username`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `personal_message`
ADD CONSTRAINT `personal_message_ibfk_1` FOREIGN KEY (`sent_by`) REFERENCES `friend` (`username`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD CONSTRAINT `personal_message_ibfk_2` FOREIGN KEY (`sent_to`) REFERENCES `friend` (`friend_username`) ON DELETE CASCADE ON UPDATE CASCADE;
