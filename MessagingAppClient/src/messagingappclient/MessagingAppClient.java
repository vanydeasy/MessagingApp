...
public class MessagingAppClient {
    ...
    public static void main(String[] argv) {
        ...
        do {
            ...
            System.out.println("6. Add member to a group");
    ...
    public static JSONObject addGroupMember() {
        Scanner reader = new Scanner(System.in);
        ...
        String response = null;
        try {
            response = QUEUE_HANDLER.call(Command.addGroupMember(username, groupName, friends).toJSONString());
        } catch (Exception ex) {
            Logger.getLogger(MessagingAppClient.class.getName()).log(Level.SEVERE, null, ex);
        }
        return stringToJson(response);
